		...
		<div id = "wrapper">
			<div id = "back_top_banner">
				...
				<div id = "content">
					...
					<div id = "main_content">
						<span class = "paragraph_title">Choose the format to download my portfolio.</span>
						<p class = "paragraph">
							<div>
								<a href = "../doc/Serrano_Resume.docx">
									<img src = "img/word.png" />	My Resume (Word format)					
								</a>
							</div>
							<div>
								<a href = "../doc/Serrano_Resume.pdf">
									<img src = "img/pdf.png" /> My Resume (PDF format)
								</a>
							</div>
						</p>
					</div>
